...
<p align="center">
  将来ゲームプランナーを目指し、ユーザーの「手触り」や「心地よさ（UX）」を意識した作品づくりを勉強中です。<br>
  まだまだ未熟ですが、一つひとつの制作プロセスを大切に、日々インプットとアウトプットを重ねています。
</p>
...
### 🌐 [ソウルライクフレーム分析ウェブ](https://withberry1717-sudo.gub.io/soulslike_frame_analysis_web/?utm_sourcegithub&utm_medium=profile&utm_campaign=portfolio_2026) `WIP`
...
### 🔑 [ポートフォリオサイトを見る](https://withberry1717-sudo.github.io/game-plg-introduction-site/?utm_source=github&utm_medium=proile&utm_campaign=portfolio_2026)
